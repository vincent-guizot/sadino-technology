      ...
      <div className="container-custom grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          ...
          >
            <Link
              href="/contact"
              className="bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg hover:scale-[1.03] transition"
            >
            ...
            <Link
              href="/portfolio"
              className="px-8 py-4 rounded-xl border text-gray-700 font-semibold hover:bg-gray-50 transition"
            >
              View Portfolio
            </Link>
          </motion.div>
          ...
          <motion.p
            ...
            initial="hidden"
            animate="show"
            className="text-xs uppercase tracking-wider text-gray-400 pt-2"
          >
        ...
        >
          ...
          <motion.div
            ...
            className="hidden md:flex items-center gap-4 absolute -bottom-6 -left-6 bg-white p-5 rounded-xl shadow-xl border"
          >
